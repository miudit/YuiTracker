...
var YUISATELLITE = function(tle0, tle1, tle2) {
    console.log("YUISATELLITE defined")
    'use strict';

    var _sat = new YUIPREDICTLIB(tle0, tle1, tle2);
    var _satOrbit = new YUIPREDICTLIB(tle0, tle1, tle2);
    var _satPasses = new YUIPREDICTLIB(tle0, tle1, tle2);
    ...
    */
    function calculateOrbit(observer, mutualObserver) {
        ...
        */
        ...
        console.log("points = " + orbitPoints)
    }
    ...
    */
    ...
    function calc(date, observer, mutualObserver) {
        ...
        if (YUISETTINGS.getCalculateEvents()) {
            _orbitCalcCounter++;
...
YUISATELLITE.getFiles = function() {
    'use strict';

    return ['/js/spmengines/predictlib.js'];
};
