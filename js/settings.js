...
//    var _spm = 'jspredict'; /* broken DO NOT USE */
    ...
    */
    function saveSettings() {
        if (YUISETTINGS.cookiesOk()) {

            var observer = YuiSatTrack.getObserver(YUIOBSERVER.types.HOME);
            ...
            /*observer = YuiSatTrack.getObserver(YUIOBSERVER.types.MUTUAL);
